...
function DHTMLgoodies_formTooltip()
{
	...
	this.arrowImageFile = 'U:/study/study/wikipipl/tooltip/js/green-arrow.gif';
	this.arrowImageFileRight = 'U:/study/study/wikipipl/tooltip/js/green-arrow-right.gif';
	this.tooltipWidth = 200;
	this.tooltipBgColor = '#f5f5f5';
